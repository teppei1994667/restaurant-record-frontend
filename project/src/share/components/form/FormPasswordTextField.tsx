...
export const FormPasswordTextField = forwardRef<HTMLInputElement, TextFieldProps>((props, ref) => {
  ...
  const passwordTextFieldRules = {
    ...
    pattern: {
      ...
      message:
        "パスワードには半角数字、半角英子文字、半角英大文字のみ使用可能です。また各種最低１桁以上含めてください",
    },
    //呼び出し元からの上書き可能
    ...rules,
  };
...
FormPasswordTextField.displayName = "FormPasswordTextField";
